const loadSamImages = (img, numFrames) => {
    const frames = Array.from({length: numFrames}, (el, i) => {
        // I noticed that all of your frames are 32 x32 so we can just
        // write one function and change the image and number of frames
        return img.get(i*32, 0, 32,32)
    })
    return frames
}
